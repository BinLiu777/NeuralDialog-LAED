...
data_arg.add_argument('--data_dir', type=str, nargs='+', default=['data/customer_service'])
...
net_arg.add_argument('--max_vocab_cnt', type=int, default=12000)
...
data_arg.add_argument('--load_sess', type=str, default="2018-02-14T12-34-00-customer-ae.py")
logger = logging.getLogger()


def main(config):

    corpus_client = corpora.CusSerCorpus(config)
