...
def process_data(lines):
    ...
    with open('customer_service/raw_sents_返学费规则.txt', 'w') as json_file:
    ...
    with open('customer_service/customer_train_返学费规则.json', 'w') as json_file:
        json_file.write(json_train)

    json_dev = json.dumps(dev_data, indent=4, ensure_ascii=False)
    with open('customer_service/customer_dev_返学费规则.json', 'w') as json_file:
        json_file.write(json_dev)

    json_test = json.dumps(test_data, indent=4, ensure_ascii=False)
    with open('customer_service/customer_test_返学费规则.json', 'w') as json_file:
